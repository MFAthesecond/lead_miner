...
const DDG_QUERIES = [
  ...
  // Ozel niceler
  'mum atölye online satış',
  'doğal sabun online mağaza türkiye',
  'kurutulmuş çiçek online satış',
  'türk halısı online satış',
  'bakır ürünleri online mağaza',
  'zeytinyağı online satış ege',
  'peynir çiftlik online sipariş',
  'drone aksesuar online türkiye',
  'kampçılık malzemeleri online mağaza',
  'yüzük kolye bileklik online türkiye',
  'termal çorap online satış',
  'puzzle yapboz online mağaza türkiye',
  'cam sanat online satış türkiye',
  'ahşap oyuncak online mağaza',
  'organik bebek ürünleri online satış',
  'vintage kıyafet online türkiye',
  'örgü iplik online mağaza türkiye',
  'baskılı tişört online sipariş türkiye',
  'poster tablo online mağaza türkiye',
  'doğal taş takı online satış',
];
